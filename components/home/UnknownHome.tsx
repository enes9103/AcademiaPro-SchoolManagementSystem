...
export const UnknownHome = () => {
  const { t } = useTranslation();
  const cards = [
    {
      title: t("homeUnknown.cardContactTitle"),
      desc: t("homeUnknown.cardContactDesc"),
      action: { label: t("homeUnknown.ctaContact"), href: "/feedbacks", icon: FiMail },
    },
    {
      title: t("homeUnknown.cardDemoTitle"),
      desc: t("homeUnknown.cardDemoDesc"),
      action: { label: t("homeUnknown.ctaDemo"), href: "/help", icon: FiExternalLink },
    },
    {
      title: t("homeUnknown.cardSupportTitle"),
      desc: t("homeUnknown.cardSupportDesc"),
      action: { label: t("homeUnknown.ctaSupport"), href: "tel:+6282294400729", icon: FiPhone },
    },
  ];
